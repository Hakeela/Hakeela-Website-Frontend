...
export default function Portfolio() {
    return(
        <div className="portfolio-root">
            <div className="logos" style={{display:"flex", gap:"10px", marginTop:"30px", marginBottom:"15px"}}>
            ...
            <div className="portfolio-text" style={{fontSize:"12px",display:"flex",flexDirection:"column", gap:"15px"}}>
            ...
            <button className="portfolio-btn" style={{marginTop:"20px", backgroundColor:"rgba(0, 0, 184, 1)", color:"white", padding:"7px 20px", border:"none", borderRadius:"20px", fontSize:"12px"}}>Get Started</button>
        </div>
    )
}